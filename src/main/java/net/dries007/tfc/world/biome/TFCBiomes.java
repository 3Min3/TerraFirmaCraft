...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension ACTIVE_OCEANIC_SHIELD_VOLCANO = register("active_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.activeShieldVolcano(seed, BiomeNoise.activeHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.ACTIVE).volcanoes(4, 0, 24, 28, true).spawnable().salty().type(RiverBlendType.CAVE));
    public static final BiomeExtension DORMANT_OCEANIC_SHIELD_VOLCANO = register("dormant_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.dormantShieldVolcano(seed,  BiomeNoise.dormantHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(2, 8, 50, 28).spawnable().salty().type(RiverBlendType.CAVE));
    public static final BiomeExtension EXTINCT_OCEANIC_SHIELD_VOLCANO = register("extinct_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.extinctShieldVolcano(seed, BiomeNoise.extinctHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(2, 8, 50, 28).spawnable().salty().type(RiverBlendType.CAVE));
    public static final BiomeExtension ANCIENT_OCEANIC_SHIELD_VOLCANO = register("ancient_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.ancientShieldVolcano(seed, 45, 95, BiomeNoise.ancientHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(2, -8, 50, 28).spawnable().salty().type(RiverBlendType.CAVE));

    public static final BiomeExtension ACTIVE_CONTINENTAL_SHIELD_VOLCANO = register("active_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.activeShieldVolcano(seed, BiomeNoise.activeHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.ACTIVE).volcanoes(4, 0, 24, 28, true).spawnable().type(RiverBlendType.CAVE));
    ...
    public static final BiomeExtension EXTINCT_CONTINENTAL_SHIELD_VOLCANO = register("extinct_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.extinctShieldVolcano(seed, BiomeNoise.extinctHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(2, 0, 36, 28).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension ANCIENT_CONTINENTAL_SHIELD_VOLCANO = register("ancient_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.weatheredShieldVolcano(seed, 90, 130, BiomeNoise.ancientHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(2, -16, 28, 28).spawnable().type(RiverBlendType.CAVE));

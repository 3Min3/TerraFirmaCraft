...
def generate(rm: ResourceManager):
    ...
    # Shore "Plants"
    configured_placed_feature(rm, ('plant', 'anemone_purple_patch'), 'tfc:creeping_ocean_plant', {'block': 'tfc:plant/anemone_purple', 'height': 5, 'radius': 3, 'integrity': 0.45, 'tide_height': 2}, decorate_chance(10), decorate_climate(-10, 16, 0, 500), decorate_square(), decorate_heightmap('ocean_floor_wg'))
    configured_placed_feature(rm, ('plant', 'anemone_green_patch'), 'tfc:creeping_ocean_plant', {'block': 'tfc:plant/anemone_green', 'height': 5, 'radius': 3, 'integrity': 0.45, 'tide_height': 2}, decorate_chance(10), decorate_climate(-16, 10, 0, 500), decorate_square(), decorate_heightmap('ocean_floor_wg'))
